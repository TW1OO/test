...
export const listings = rawListings.map(l => {
  ...
  return {
    ...
    fireStationDist:    d.fireStation?.dist      ?? null,
    fireStationName:    d.fireStation?.poi.name  ?? null,
    fireStationPoiLat:  d.fireStation?.poi.lat   ?? null,
    fireStationPoiLng:  d.fireStation?.poi.lng   ?? null,
    adminDist:          d.admin?.dist            ?? null,
    adminName:          d.admin?.poi.name        ?? null,
    adminPoiLat:        d.admin?.poi.lat         ?? null,
    adminPoiLng:        d.admin?.poi.lng         ?? null,
  }
})
